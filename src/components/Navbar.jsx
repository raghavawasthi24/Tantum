...
export default function Navbar() {
  ...
  return (
    <nav className="flex w-full fixed top-0 bg-white bg-opacity-70 justify-between items-center px-4 py-2">
      <p className="text-blue-700 font-bold text-xl md:text-4xl">Tantum.</p>
